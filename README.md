...
How It Works
Upload your dataset (e.g., game logs from FanGraphs)
Select a time column (Game or Date) and a stat (OPS, OBP, etc.)
The tool:
...
Outputs include metrics, trend charts, and insights
Example Data
Game,OPS
1,0.850
2,0.920
